...
# ── Embedded data (self-contained — no external files needed) ──────────────
_WS_JSON = r"""
...
"""
WS = json.loads(_WS_JSON)

_STRIDE_GUIDE_JSON = r"""
...
"""
STRIDE_GUIDE = json.loads(_STRIDE_GUIDE_JSON)
...
"""
C4_LAYOUTS = json.loads(_C4_LAYOUTS_JSON)
...
"""
GLOSSARY = json.loads(_GLOSSARY_JSON)
...
"""
WS_STRIDE = json.loads(_WS_STRIDE_JSON)
